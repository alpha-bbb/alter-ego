...
async def analyze_action(
    ...
    try:
        ...
        system_prompt = """
        # タスク: 行動分析
          - 相手からの最後の発言を分析し、相手の行動を予測してください。
        # 指示
          - 与えられた会話を注意深く読み、相手が取ろうとしている行動や意図を分析してください。
          - roleがSELFの場合は自分を表します。
          - 行動の予測には、以下の選択肢から最も適切なものを選んでください：
            - お誘い
            - 世間話
            - 愚痴・悩み相談
            - 近況報告
            - お願い
            - その他
          - 予測した行動に対する自信の度合いを0から1の範囲でスコアとして評価してください。
          - 相手の発言の主なポイントを分析して下さい。
        """
